...
public class PolrReset {
	public static boolean execute(HttpServletResponse response)
	{
	    ...
	    ResultSet rs = null;
	    String[] query = {
	    		"CREATE TABLE polr2(id int PRIMARY KEY AUTO_INCREMENT, title text, content text NOT NULL, answers int NOT NULL DEFAULT 0, date timestamp NOT NULL DEFAULT NOW(), bump timestamp NOT NULL DEFAULT NOW(), subbump timestamp NOT NULL DEFAULT NOW(), responses int NOT NULL DEFAULT 0, subresponses int NOT NULL DEFAULT 0, FULLTEXT(title, content)) CHARACTER SET utf8 COLLATE utf8_general_ci",
	    		"DELETE FROM polr",
